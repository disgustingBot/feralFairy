...
<section class="abstract">
    ...
    <section class="dopel">
      <img src="" alt="" class="dopel_image">
      <div class="dopel_caption">
        <p class="dopel_title">How we work</p>
        <p class="dopel_txt">
          Based in our Calais warehouse, the vast majority of our work relies on private donations and relationships with partners. Public subsidies allow us to cover part of our expenses, but it is the donations that allow us to continue our work independently.
          <br>
          All donations are used to provide humanitarian aid and promote the dignity of displaced people in region.
        </p>
        <a href="" class="dopel_btn">Find out about our partners</a>
      </div>
    </section>



    <section class="dopel alt">
      <img src="" alt="" class="dopel_image">
      <div class="dopel_caption">
        <p class="dopel_title">Our team</p>
        <p class="dopel_txt">
          L’Auberge des Migrants is made up of a network of paid employees and volunteers based in Calais but working across the region. In 2017, 118,000 hours of volunteering were carried out on our actions. Valued in euros, this amounts to €1.3 million of voluntary contribution.
          <br><br>
          Our leadership team consists of François Guennoc – President, Loan Torondel – Vice-President, Catherine Konforti, Secretary, and Alain Gendron, treasurer.
        </p>
        <a href="" class="dopel_btn"></a>
      </div>
    </section>
    ...
    <section class="content">
      ...
      <h4>2007-2008: Beginnings</h4>
      <p>Having worked in Calais for over 20 years, La Belle Etoile ceases operations. In reaction, volunteers associated with the organisation create L’Auberge des Migrants.</p>
      <h4>2014-2016: L’Auberge grows</h4>
      <p>
      ...
      <h4>After October 2016: A new way of doing things</h4>
      <p>
